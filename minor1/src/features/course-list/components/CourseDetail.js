...
export default function CourseDetail() {
  ...
  const handleSave = (e) =>{
    if(items.findIndex(item=>item.course.id===course.id)<0){
const newItem = {quantity:1,course:course.id,user:user.id};
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 ">
              ...
              <div className="flex flex-col border-2 border-gray-100 rounded-xl h-[35rem] gap-5">
                ...
                <div className="flex justify-around p-2">
                  ...
                  <button className="bg-gray-300 text-black rounded-md  p-4 w-[10rem] font-bold z-[99]" onClick={handleSave}>
                    Save
                  </button>
                </div>
              </div>
